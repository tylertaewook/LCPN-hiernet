...
parser.add_argument("-tr", "--traindir", type=str, default="../input/train/", help="Train Directory")
parser.add_argument("-te", "--testdir", type=str, default="../input/val/", help="Test Directory")
...
def declare_model(train_loader):
...
if __name__ == "__main__":
    ...
    classifier, criterion = declare_model(train_loader)
