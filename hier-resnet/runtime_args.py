...
parser.add_argument('--train_csv', type=str, help='Specify the path to the train csv file.', default='/root/fashion-effnet/hier-resnet/dataset/train.csv')
parser.add_argument('--test_csv', type=str, help='Specify the path to the test csv file.', default='/root/fashion-effnet/hier-resnet/dataset/test.csv')
parser.add_argument('--metafile', type=str, help='Specify the path to the test csv file.', default='/root/fashion-effnet/hier-resnet/dataset/pickle_files/chanel_meta')
parser.add_argument('--model_save_path', type=str, help='Specify the path to save the model.', default='/root/fashion-effnet/hier-resnet/')
parser.add_argument('--graphs_folder', type=str, help='Specify the path to save the graphs.', default='/root/fashion-effnet/hier-resnet/graph_folder/')
