...
class HierarchicalLossNetwork:
    ...
    def words_to_indices(self):
        ...
        return numeric_hierarchy # {0: [0, 1, 2, 3, 4, 5], 1: [6, 7, 8, 9], 2: [10, 11, 12, 13, 14], 3: [15, 16, 17, 18]}
    ...
    def check_hierarchy(self, current_level, previous_level):
        ...
        # return torch.FloatTensor([True, True, True, True,True, True,True, True,True,True]).to(self.device)
